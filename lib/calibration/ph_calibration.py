def calibration_preview(ph_label, temp_c_label, temp_f_label, rssi_label, time_label,
                        button_next, button_abort, pixel):
    import time
...
def run_calibration(ph_sensor, read_temperature, ph_label, temp_c_label, temp_f_label, rssi_label, time_label,
                    button_next, button_abort, pixel, watchdog=None):
    import time
        ...
        while True:
            ...
            if not button_next.value and not next_was_pressed:
                ...
                try:
                    ...
                    pre_level = int(pre_status.split(',')[1]) if ',' in pre_status else 0
                    ...
                    while time.monotonic() - query_start < 5.0:
                        try:
                            ...
                            new_level = int(result.split(',')[1]) if ',' in result else pre_level
